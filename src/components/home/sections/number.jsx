...
import bgImage from "../../../assets/Images/numbersBG.jpg";
...
const Numbers = () => {
  ...
  const data = [
    ...
    {
      icon: <FaBullhorn />,
      title: "BTL Advertising Campaigns",
      count: 3200,
      duration: 2.5,
      separator: ",",
    },
    {
      icon: <FaHandsHelping />,
      title: "CSR & Public Awareness Projects",
      count: 300,
      duration: 2,
    },
    {
      icon: <FaRecycle />,
      title: "Sustainable Media Installations",
      count: 250,
      duration: 2,
    },
    {
      icon: <FaPaintBrush />,
      title: "Creative Assets Produced Annually",
      count: 5000,
      duration: 2.5,
      separator: ",",
    },
    {
      icon: <FaUsers />,
      title: "Global Creative Collaborators",
      count: 35,
      duration: 2,
    },
    {
      icon: <FaTasks />,
      title: "Out-of-Home Marketing Executions",
      count: 1100,
      duration: 2.5,
      separator: ",",
    },
    {
      icon: <FaGlobe />,
      title: "International Agency Partnerships",
      count: 7,
      duration: 2,
    },
  ];
